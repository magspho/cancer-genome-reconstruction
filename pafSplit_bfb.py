...
def ctg_pass_multimap_filter(ctg_paf, ctg_mapcnt_dict, chr_censat_dict, len_thres = 100):
...
def split_by_chrom(paf_filename, bed_filename=None, ctglen_thres = 1000, ctgspan_thres = 1000, mq_thres = 2):
    '''
    Input:
...
def split_by_chrom_utg(paf_filename, bed_filename, utglen_thres = 100, utgspan_thres = 100, mq_thres = 2):
